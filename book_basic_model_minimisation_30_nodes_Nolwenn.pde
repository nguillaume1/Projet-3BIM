...
double so = 7 ;              // sensor offset distance (a scaling parameter)
...
double projectvalue = 2 ;    // how big is the value for the data nodes which we project onto the chemoattractant field
...
int wid = 300 ;               // width of environment
int hei = 300 ;               // height of environment
